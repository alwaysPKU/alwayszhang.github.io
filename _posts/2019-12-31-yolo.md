...
where $\mathbb{𝟙}_i^{\text{obj}}$ denotes if object appears in cell $i$ and $\mathbb{𝟙}_i^{\text{obj}}$ denotes that the $j$th bounding box predictor in cell $i$ is “responsible” for that prediction.
