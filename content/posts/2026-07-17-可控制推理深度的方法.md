...
1. **DeepSeek 官方文档** - Thinking Mode API
   ...
   - 核心内容：`enable_thinking` 参数控制，支持 true/false 开关

2. **Google Gemini API 文档** - Thinking Config
   - https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/gemini
   - 核心内容：`thinking_level` 参数，支持 MINIMAL/LOW/MEDIUM/HIGH 四级控制

3. **OpenAI API 文档** - Reasoning Effort
   - https://platform.openai.com/docs/api-reference/chat/create
   - 核心内容：`reasoning_effort` 参数，支持 low/medium/high 三档
...
5. **Qwen 官方文档** - Thinking Mode
   ...
   - 核心内容：`enable_thinking` 参数，与 DeepSeek 类似的开关模式
...
7. **Self-Consistency** - Wang et al., 2022
